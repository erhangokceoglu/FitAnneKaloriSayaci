...
{
    public partial class UrunDuzenlemeEkrani2 : Form
    {
        ProjectContext _db;
        Urun yeniUrun;

        public UrunDuzenlemeEkrani2()
        {
            InitializeComponent();
        ...
        {
            #region Alanlari Doldurma İşlemleri
        ...
        private void UrunDuzeltmeEkrani2_FormClosed(object sender, FormClosedEventArgs e)
        {
